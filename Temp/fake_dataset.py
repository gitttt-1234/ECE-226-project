...
class FAKEGINDataset(object):
    ...
    def __init__(self, fake_path, name, self_loop,g_classes, fea_dim, degree_as_nlabel=False):
    ...
    def _load(self):
        ...
        with open(self.file, 'r') as f:
            ...
            for i in range(self.N):
                ...
                g.ndata['label'] = torch.from_numpy(np.array(nlabels))
            ...
            for g in self.graphs:
                ...
                g.ndata['attr'] = torch.zeros((g.number_of_nodes(), self.fea_dim))
