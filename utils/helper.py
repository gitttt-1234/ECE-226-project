...
def generate_graphs(dataset,sturectures, features, targets, path, daseed, trial, modelname, bat_num, total_num):
    
    graph_num = len(sturectures)
 
    filep = path+modelname+'fake_'+dataset+ str(daseed)+'_'+str(trial)+ '.txt'
